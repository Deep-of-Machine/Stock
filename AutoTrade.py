...
myToken = "xoxb-2383270777063-2421647110800-RwNvXjA48g1StsvFB8Jk3AQd"
def dbgout(message):
...
def get_target_price(code):
    ...
    try:
        ...
        target_price = today_open + (lastday_high - lastday_low) * 0.2      #전날 변동성 기준 20퍼, default 0.5
        return target_price
...
if __name__ == '__main__': 
    try:
        symbol_list = ['A252670', 'A251340', 'A114800', 'A122630', 'A233740', 'A371460', 'A252710', 'A069500', 'A229200', 'A305540', 'A253230', 'A252420', 'A271050', 'A217770', 'A145670', 'A301410', 'A219390', 'A233160', 'A117680', 'A139230']
        bought_list = []     # 매수 완료된 종목 리스트
        target_buy_count = 6 # 매수할 종목 수
        buy_percent = 0.16  #몇퍼 살껀지
